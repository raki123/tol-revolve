...
//  	sleep(20);
  ...
  // Initialise controller
  controller_ = revolve::brain::RafCPGControllerPtr(new revolve::brain::RafCPGController(modelName,
  ...
  if (path_to_first_brains == "" || path_to_first_brains == "none") {
    ...
    brains_from_first = boost::dynamic_pointer_cast<CPPNEAT::NEATLearner>(learner_)->get_brains_from_yaml(path_to_first_brains, -1);
  }
  ...
  if (path_to_second_brains == "" || path_to_second_brains == "none") {
    ...
    brains_from_second = boost::dynamic_pointer_cast<CPPNEAT::NEATLearner>(learner_)->get_brains_from_yaml(path_to_second_brains, -1);
  }
  ...
  boost::dynamic_pointer_cast<CPPNEAT::NEATLearner>(learner_)->initialise(init_brains);
